...
<div class="border-b border-gray-200 pb-8 mb-8">
   <h2 class="text-4xl font-semibold text-gray-900 sm:text-5xl">Agregar nuevo enlace</h2>
</div>
...
<form method="POST" action="/links/store" class="space-y-4 max-w-xl">
   <div>
      <label for="url" class="block text-sm font-medium text-gray-700">URL</label>
      <input type="url" name="url" id="url" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
   </div>
   <div>
   ...
   <div>
      ...
      <input type="text" name="category" id="category" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" placeholder="Herramientas de Desarrollo">
   </div>
   <div>
